...
osThreadId linReceiverTaskHandle;
...
/* USER CODE BEGIN Header_StartLinReceiverTask */
/**
  * @brief  Function implementing the linReceiverTask thread.
